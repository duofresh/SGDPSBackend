...
router.post('/submit', async (req: Request, res: Response) => {
  ...
  if (!submission.user || !submission.level || !submission.link || !submission.percent || !submission.hz) {
...
router.post('/moderate', authenticate, authorize('moderator', 'admin', 'owner', 'senior-list-mod'), async (req: Request, res: Response) => {
  ...
  if (action === 'accept') {
    ...
    levelData.records.push({ user: submission.user, link: submission.link, percent: submission.percent, hz: submission.hz });
